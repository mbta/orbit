  ...
  describe("certificate combinations", () => {
    ...
    describe("expiring soon", () => {
      test("displays a warning box for one expiring within 30 days", () => {
        ...
        expect(
          view.getByText(
            "Our records show that Test Name's ROW Card expires in 12 days on 5/18/2024.",
          ),
        ).toBeInTheDocument();
      });
      ...
      test("displays a warning box for one expiring in 30 days", () => {
        ...
        expect(
          view.getByText(
            "Our records show that Test Name's ROW Card expires in 30 days on 6/8/2024.",
          ),
        ).toBeInTheDocument();
      });
      ...
      test("displays a warning box for one expiring tomorrow (current time ~3pm)", () => {
        ...
        expect(
          view.getByText(
            "Our records show that Test Name's ROW Card expires tomorrow on 5/18/2024.",
          ),
        ).toBeInTheDocument();
      });
